...
window.GLINT_I18N = {
  en: {
    ...
    trialEndedSub: "Keep Glint for a one-time $2.99 on Ko-fi. Already bought? Paste your key below.",
    ...
    ghTokenHint: "Used for PR status and HTTPS push/pull. Leave the field empty and save to remove it.",
    ghTokenActive: "Token saved.",
    ghTokenNone: "No token saved.",
    ghTokenError: "Couldn't save the token.",
    ...
    obTitle: "Connect a repository",
    obSub: "Point Glint at a Git repo on your Mac - one you cloned from GitHub, GitLab, Bitbucket, or any other remote.",
    obOpen: "Open a repository",
    obHint: "Push and pull use your existing SSH keys, or a GitHub token you can add in Settings.",
    notARepo: "That folder isn't a Git repository.",
    mpTitle: "How should Glint live?",
    mpSub: "Pick how you want to open it. You can change this later in Settings.",
    mpMenubar: "Menu bar",
    mpMenubarDesc: "An icon in the menu bar; the panel drops down on click. No Dock icon.",
    mpDock: "Dock window",
    mpDockDesc: "A normal app window that lives in the Dock, like most apps.",
    displayMode: "Show Glint in",
    displayModeHint: "Switching relaunches Glint.",
    openDiff: "Open diff",
  ...
  el: {
    ...
    trialEndedSub: "Κρατήστε το Glint με μια εφάπαξ πληρωμή $2.99 στο Ko-fi. Το αγοράσατε ήδη; Επικολλήστε το κλειδί σας παρακάτω.",
    ...
    github: "GitHub",
    saveToken: "Αποθήκευση token",
    ghTokenPlaceholder: "ghp_...",
    ghTokenHint: "Χρησιμοποιείται για την κατάσταση PR και για push/pull μέσω HTTPS. Αφήστε το πεδίο κενό και αποθηκεύστε για να το αφαιρέσετε.",
    ghTokenActive: "Το token αποθηκεύτηκε.",
    ghTokenNone: "Δεν έχει αποθηκευτεί token.",
    ghTokenError: "Δεν ήταν δυνατή η αποθήκευση του token.",
    ...
    obTitle: "Συνδέστε ένα αποθετήριο",
    obSub: "Δείξτε στο Glint ένα αποθετήριο Git στον Mac σας - ένα που κλωνοποιήσατε από GitHub, GitLab, Bitbucket ή οποιοδήποτε άλλο remote.",
    obOpen: "Άνοιγμα αποθετηρίου",
    obHint: "Το push και το pull χρησιμοποιούν τα κλειδιά SSH σας ή ένα token GitHub που μπορείτε να προσθέσετε στις Ρυθμίσεις.",
    notARepo: "Αυτός ο φάκελος δεν είναι αποθετήριο Git.",
    mpTitle: "Πώς να ζει το Glint;",
    mpSub: "Διάλεξε πώς θέλεις να το ανοίγεις. Μπορείς να το αλλάξεις αργότερα στις Ρυθμίσεις.",
    mpMenubar: "Γραμμή μενού",
    mpMenubarDesc: "Ένα εικονίδιο στη γραμμή μενού· το πάνελ ανοίγει με κλικ. Χωρίς εικονίδιο στο Dock.",
    mpDock: "Παράθυρο στο Dock",
    mpDockDesc: "Ένα κανονικό παράθυρο εφαρμογής στο Dock, όπως οι περισσότερες εφαρμογές.",
    displayMode: "Εμφάνιση του Glint",
    displayModeHint: "Η αλλαγή επανεκκινεί το Glint.",
  ...
  sq: {
    ...
    trialEndedSub: "Mbaje Glint me një pagesë të vetme $2.99 në Ko-fi. E ke blerë tashmë? Ngjit çelësin tënd më poshtë.",
    ...
    github: "GitHub",
    saveToken: "Ruaj token-in",
    ghTokenPlaceholder: "ghp_...",
    ghTokenHint: "Përdoret për statusin e PR-ve dhe push/pull me HTTPS. Lëre fushën bosh dhe ruaj për ta hequr.",
    ghTokenActive: "Token-i u ruajt.",
    ghTokenNone: "S'ka token të ruajtur.",
    ghTokenError: "Token-i s'u ruajt dot.",
    ...
    obTitle: "Lidh një depo",
    obSub: "Drejtoje Glint te një depo Git në Mac-un tënd - një që e klonove nga GitHub, GitLab, Bitbucket ose çdo remote tjetër.",
    obOpen: "Hap një depo",
    obHint: "Push dhe pull përdorin çelësat e tu SSH, ose një token GitHub që mund ta shtosh te Cilësimet.",
    notARepo: "Ajo dosje s'është një depo Git.",
    mpTitle: "Si të jetojë Glint?",
    mpSub: "Zgjidh si do ta hapësh. Mund ta ndryshosh më vonë te Cilësimet.",
    mpMenubar: "Shiriti i menysë",
    mpMenubarDesc: "Një ikonë në shiritin e menysë; paneli hapet me klik. Pa ikonë në Dock.",
    mpDock: "Dritare në Dock",
    mpDockDesc: "Një dritare normale aplikacioni në Dock, si shumica e aplikacioneve.",
    displayMode: "Shfaq Glint në",
    displayModeHint: "Ndryshimi rihap Glint.",
